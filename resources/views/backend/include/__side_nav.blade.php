<div class="side-nav">
    <div class="side-nav-inside">
        <ul class="side-nav-menu">
            ...
            <li class="side-nav-item side-nav-dropdown {{ isActive(['admin.ads.index','admin.ads.pending','admin.ads.active','admin.ads.inactive','admin.ads.rejected','admin.ads.create','admin.ads.edit
            ']) }}">
                <a href="javascript:void(0);" class="dropdown-link"><i data-lucide="table-cells-split"></i><span>{{
                        __('Manage Ads') }}</span><span class="right-arrow"><i
            ...
            <li class="side-nav-item side-nav-dropdown {{ isActive(['admin.ads.report.*','admin.ads.reports']) }}">
                <a href="javascript:void(0);" class="dropdown-link"><i data-lucide="message-circle-warning"></i><span>{{
                        __('Manage Ads Reports') }}</span><span class="right-arrow"><i
                            data-lucide="chevron-down"></i></span></a>
                <ul class="dropdown-items">
            ...
            <li class="side-nav-item {{ isActive(['admin.navigation.*','admin.dashboard.navigation.*'],classForArr: 'active') }}">
