            ...
            <div class="row">
                <div class="col">
                    <div class="title-content">
                        <h2 class="title">{{ __('Add Investment Plan') }}</h2>
            ...
            <div class="col-xl-12">
                <div class="site-card">
                    <div class="site-card-body">
                        <form action="{{ route('admin.investment.plan.store') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-xxl-4">
                                ...
                                <div class="col-xxl-8">
                                    <div class="site-input-groups">
                                        ...
                                        <input type="text" name="description" class="box-input mb-0" value="{{ old('description') }}"/>
                                    </div>
                                </div>
                                <div class="col-xxl-4">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="number" step="0.01" name="min_amount" class="form-control" value="{{ old('min_amount') }}" required/>
                                ...
                                <div class="col-xxl-4">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="number" step="0.01" name="max_amount" class="form-control" value="{{ old('max_amount') }}" required/>
                                            <span class="input-group-text">{{ $currency }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xxl-4">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="number" step="0.01" name="roi" class="form-control" value="{{ old('roi') }}" required/>
                                ...
                                <div class="col-xxl-4">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="input-group joint-input">
                                            <input type="number" name="duration" class="form-control" value="{{ old('duration', 0) }}" required/>
                                ...
                                <div class="col-xl-4">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            <input type="radio" id="return_capital_yes" name="return_capital" value="1" @checked(old('return_capital', 1) == 1)/>
                                            <label for="return_capital_yes">{{ __('Yes') }}</label>
                                            <input type="radio" id="return_capital_no" name="return_capital"value="0" @checked(old('return_capital') == 0)/>
                                ...
                                <div class="col-xl-4">
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            <input type="radio" id="status_active" name="status" value="1" @checked(old('status', 1) == 1)/>
                                            <label for="status_active">{{ __('Active') }}</label>
                                            <input type="radio" id="status_inactive" name="status"value="0" @checked(old('status') == 0)/>
